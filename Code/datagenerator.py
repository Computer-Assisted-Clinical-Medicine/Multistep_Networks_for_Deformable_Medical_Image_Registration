...
class DataGenerator(tensorflow.keras.utils.Sequence):
    ...
    def __init__(self, fixed_filenames, path_fixed, moving_filenames, path_moving, batch_size,shape):
...
def get_test_images(fixed_filename, path_fixed, moving_filename, path_moving):
