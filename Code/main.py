...
def training(f, architecture, variant, losses,  loss_weights, learning_rate, nb_features,  nb_epochs, batch_size, seed=42):
    ...
    training_batch_generator = DataGenerator(traindata_files_fixed, cfg.path_fixed, traindata_files_moving, cfg.path_moving, batch_size, inshape)
    validation_batch_generator = DataGenerator(valdata_files_fixed, cfg.path_fixed, valdata_files_moving, cfg.path_moving, batch_size, inshape)
        ...
        try:
            ...
            if cfg.seg_available:
                result_metrics = evaluation.evaluate_prediction(result_metrics, predict_path,
                                                            ...
                                                            cfg.path_fixed, filename_fixed, filename_moving,
...
# Proposed multistep network:
architecture='MultistepA'
variant='DDDD'

architecture='MultistepB'
variant='DDD'

architecture='MultistepC'
variant='DD'
